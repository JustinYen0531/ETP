...
### [Module 1] Justin: Overview
**Topic:** Introduction, Teams, and General Flow.

"Hello everyone! Welcome to the ETP Game Show! Today, we aren't just here for a quiz; we are here for a high-frequency competitive battle. I'm Justin, and I'll walk you through the **Overview** of our tournament.

Our game features four elite teams: ALPHA, BETA, GAMMA, and DELTA. Each team is led by one of us on this stage. The objective is simple but challenging: you must navigate the board, capture subject tiles, and upgrade your holdings to build the ultimate business empire. 

The basic flow is easy to follow: We’ll start by randomizing your teams, then we’ll initiate the board protocol. You’ll roll, move, answer, and score. We repeat this cycle until every subject tile on the board has reached its maximum level. Your mission is to finish with the highest total score in the room. Are you ready to begin? Let’s look at the battlefield. Ally, show them the Board!"
...
### [Module 3] Kelly: Questions
**Topic:** Difficulty Levels, Formats, and Fate Surprises.

"Thanks, Ally! Now, what kind of **Questions** will you face? We have three distinct levels of intensity. Level 1 is 'Fill in the Blanks', Level 2 involves 'Calculations', and Level 3 requires an 'Open Response' to deep conceptual questions. As you might expect, higher levels mean higher stakes: Level 1 nets you 100 points, Level 2 gives 200, and Level 3 is worth a massive 300 points!

But it’s not all academic. On Fate tiles, you might trigger a **Life Question**—fun trivia about your mentors with pictures and hints. Or, you might face a **Physical Challenge**. Landing here means your team might have to dance for 15 seconds, do push-ups, or face Justin in Rock-Paper-Scissors! 

To win, you’ll need a mix of book smarts, memory of our lives, and some physical stamina! So, stay sharp and keep those muscles ready. Carrie, how do we decide the ultimate winner?"

---

### [Module 4] Carrie: Winning
**Topic:** Scoring, Betting, and Final Victory.
...
*   **Engagement:** If your team members are quiet or hesitant, take the lead to facilitate discussion and encourage everyone to speak.
*   **Strategic Hints:** You may offer hints or guide the team's thinking process, but you are **forbidden** from providing the final answer. Let the students reach the conclusion themselves.
